...
(library (r6rs racket base private for)
  ...
  (define-syntax for/fold
    (syntax-rules (:when :unless :do :break :final)
      [(_ [rest-id init-expr] () body-or-break ... body)
       (let*-values ([rest-id init-expr]
                     [rest-id (begin body-or-break ... body)])
         (identity rest-id))]
      [(_ [rest-id init-expr] ([id seq-expr] ...) body-or-break ... body)
  ...
  (define-syntax for*/fold
    (syntax-rules (:when :unless :do :break :final)
      [(_ [rest-id init-expr] () body-or-break ... body)
       (for/fold [rest-id init-expr] () body-or-break ... body)]
      [(_ [rest-id init-expr] ([id seq-expr]) body-or-break ... body)
       (for/fold [rest-id init-expr] ([id seq-expr]) body-or-break ... body)]
      [(_ [rest-id init-expr] ([id1 seq-expr1] [id2 seq-expr2] ...) body-or-break ... body)
